    ...
    <div class="container-fluid pt-4 px-4">
        <div class="bg-secondary rounded p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h6 class="mb-0 text-white">{{ isset($page) ? 'Edit Page' : 'Create New Page' }}</h6>
                <a href="{{ route('admin.pages.index') }}" class="btn btn-outline-light"><i
                        class="fa fa-arrow-left me-2"></i>Back</a>
            </div>

            <!-- Form for Creating or Editing Page -->
            <form action="{{ isset($page) ? route('admin.pages.update', $page->id) : route('admin.pages.store') }}"
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <!-- Page Content -->
                        <div class="mb-3">
                            <label class="form-label text-white">Content <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="bg-dark rounded p-3 mb-3">
                            ...
                            <button type="submit" class="btn btn-primary w-100"><i
                                    class="fa fa-save me-2"></i>{{ isset($page) ? 'Update Page' : 'Save Page' }}</button>
                        </div>
                        ...
                        <div class="bg-dark rounded p-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="meta_title"
                                    value="{{ old('meta_title', $page->meta_title ?? '') }}" placeholder="Optional">
                            </div>
                            <div class="mb-3">
