{{-- TopNavBar --}}
<nav class="fixed top-0 w-full z-50 border-b border-slate-100 dark:border-slate-800 shadow-sm dark:shadow-none bg-white/95 dark:bg-slate-900/95 backdrop-blur-sm text-slate-900 dark:text-slate-50 font-label-caps antialiased tracking-tight">
