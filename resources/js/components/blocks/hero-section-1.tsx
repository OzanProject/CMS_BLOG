...
export function HeroSection({ articles = [], settings = {} }: { articles?: any[], settings?: any }) {
        ...
        <>
            ...
            <main className="overflow-hidden">
                <div
                    ...
                    <div className="w-[35rem] h-[80rem] -translate-y-[350px] absolute left-0 top-0 -rotate-45 rounded-full hero-glow-1" />
                    <div className="h-[80rem] absolute left-0 top-0 w-56 -rotate-45 rounded-full hero-glow-2 [translate:5%_-50%]" />
                    <div className="h-[80rem] -translate-y-[350px] absolute left-0 top-0 w-56 -rotate-45 hero-glow-3" />
                </div>
                <section>
                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <a
                                        href={mainArticle ? `/article/${mainArticle.slug}` : "#"}
                                        className="hover:bg-background dark:hover:border-t-border bg-muted group mx-auto flex w-fit items-center gap-4 rounded-full border p-1 pl-4 shadow-md shadow-black/5 transition-all duration-300 dark:border-t-white/5 dark:shadow-zinc-950">
                                        <span className="text-foreground text-sm">{mainArticle ? mainArticle.category?.name || "Featured" : "New Updates"}</span>
                                    ...
                                    <h1
                                        className="mt-8 max-w-4xl mx-auto text-balance text-6xl md:text-7xl lg:mt-16 xl:text-[5.25rem] font-black tracking-tighter leading-none italic uppercase">
                                        {mainArticle ? mainArticle.title : "Modern CMS Experience"}
                                    </h1>
                                    <p
                                        className="mx-auto mt-8 max-w-2xl text-balance text-lg text-muted-foreground font-medium">
                                        {mainArticle ? mainArticle.excerpt : "Highly customizable components for building modern websites and applications that look and feel the way you mean it."}
                                    </p>
                                </AnimatedGroup>
                                ...
                                <AnimatedGroup
                                    ...
                                    <div
                                        ...
                                        <Button
                                            ...
                                            <a href={mainArticle ? `/article/${mainArticle.slug}` : "#"}>
