...
return [
    ...
    'settings'      => [
        'default' => [
            ...
            'CSS.AllowedProperties'    => 'font,font-size,font-weight,font-style,font-family,text-decoration,text-align,color,background-color,padding,padding-top,padding-right,padding-bottom,padding-left,margin,margin-top,margin-right,margin-bottom,margin-left,border,border-radius,border-color,border-style,border-width,width,height,float,clear,line-height,letter-spacing,list-style-type,vertical-align',
            'CSS.Trusted'              => true,
