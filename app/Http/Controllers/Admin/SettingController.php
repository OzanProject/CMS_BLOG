...
class SettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $request->validate([
            ...
            'ad_in_article_active' => 'nullable|in:0,1',
            'ad_in_article_frequency' => 'nullable|integer|min:1|max:10',
            'ad_in_article_max' => 'nullable|integer|min:1|max:20',
            'adsense_active' => 'nullable|in:0,1',
            'adsense_auto_ads' => 'nullable|in:0,1',
            'adsterra_active' => 'nullable|in:0,1',
